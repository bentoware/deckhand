...
- `deckhand-skills-repo-avatar.png`: 1024px GitHub repository avatar for `bentoware/deckhand-skills`.
- `deckhand-skills-repo-avatar-512.png`: 512px copy for smaller upload targets.
...
The Deckhand avatar is a square crop of the human deckhand from `../deckhand-hero.jpg`, framed for GitHub's circular repository avatar display. The Deckhand Skills avatar is a square crop of the cat from `../deckhand-crew-strip.jpg`. The Bentoware avatar keeps the same family style but uses a broader compass/code-bracket studio mark so it can stand apart from the repo.
...
Deckhand Skills crop source:

```sh
magick ../deckhand-crew-strip.jpg -crop 430x430+855+300 +repage -resize 1024x1024 -strip deckhand-skills-repo-avatar.png
```
